...
qplot(x=presentation.time, y=rt, facets = .~operand, data = ds.f, geom="bar", stat="identity", position = "dodge", colour = "red") + geom_errorbar(aes(ymin = rt-sem, ymax = rt+sem), width = 0.2)
